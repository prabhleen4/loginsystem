...
<div class="book-container">
    <img class="book-image" src="donated/don5.webp" alt="Book Cover">
    <div class="book-details">
        <div class="book-title" id="book-title">The Art of Public Speaking</div>
        <div class="book-author"><strong>Author:</strong> Dale Carnegie and J. Berg</div>
        <div class="book-isbn"><strong>ISBN:</strong> 978-0-071811-45-3</div>
        <div class="book-price"><strong>Price:</strong> Rs. 500</div>
        <div class="book-description">
            <strong>Book Description:</strong>
            <p>"The Art of Public Speaking" provides essential techniques and tips for effective communication, enhancing public speaking skills, and building confidence. Carnegie and Berg share insights that empower readers to engage audiences and deliver impactful presentations.</p>
        </div>
