...
<section>
    ...
    <div class="book-container">
        <img class="book-image" src="new/arrival_1.jpg" alt="Book Cover">
        <div class="book-details">
            <div class="book-title" id="book-title">The Giver</div>
            <div class="book-author"><strong>Author:</strong> Lois Lowry
            </div>
            <div class="book-isbn"><strong>ISBN:</strong> 978-0-00714-14-2 </div>
            <div class="book-price"><strong>Price:</strong> Rs.750</div>
