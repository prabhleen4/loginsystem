...
<section>
    ...
    <div class="book-container">
        <img class="book-image" src="new/arrival_10.jpg" alt="Book Cover">
        <div class="book-details">
            <div class="book-title" id="book-title">Percy Jackson & the Olympians: The Lightning Thief
            </div>
            <div class="book-author"><strong>Author:</strong> Rick Riordan</div>
            <div class="book-isbn"><strong>ISBN:</strong> 978-0-756966-03-4</div>
            <div class="book-price"><strong>Price:</strong> Rs. 280</div>
            <div class="book-description">
                <strong>Book Description:</strong>
                <p>The Lightning Thief is a 2005 American fantasy-adventure novel based on Greek mythology, the first children's novel by Rick Riordan. The opening
                     installment in the series Percy Jackson & the Olympians, the book was recognized among the year's best for children</p>
            </div>
