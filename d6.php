...
<div class="book-container">
    <img class="book-image" src="donated/don6.webp" alt="Book Cover">
    <div class="book-details">
        <div class="book-title" id="book-title">How to Win Friends and Influence People</div>
        <div class="book-author"><strong>Author:</strong> Dale Carnegie</div>
        <div class="book-isbn"><strong>ISBN:</strong> 978-0-671022-67-0</div>
        <div class="book-price"><strong>Price:</strong> Rs. 450</div>
        <div class="book-description">
            <strong>Book Description:</strong>
            <p>Dale Carnegie's classic, "How to Win Friends and Influence People," offers timeless principles for improving interpersonal skills, fostering relationships, and persuading others. The book is filled with practical advice and strategies for effective communication and social interaction.</p>
        </div>
