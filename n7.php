...
<body>
    ...
    <div class="book-container">
        <img class="book-image" src="new/arrival_7.jpg" alt="Book Cover">
        <div class="book-details">
            <div class="book-title" id="book-title">The Heroes of Olympus: The Lost Hero</div>
            <div class="book-author"><strong>Author:</strong> Rick Riordan</div>
            <div class="book-isbn"><strong>ISBN:</strong> 978-1-423142-65-2</div>
            <div class="book-price"><strong>Price:</strong> Rs. 800</div>
            <div class="book-description">
                <strong>Book Description:</strong>
                <p>The Lost Hero is an American fantasy-adventure novel written by Rick Riordan, based on Greek and Roman mythology. It was published on October 12, 
                    2010, and is the first book in The Heroes of Olympus series, a sequel to the Percy Jackson & the Olympians series.</p>
            </div>
