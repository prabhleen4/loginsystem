...
<div class="book-container">
    <img class="book-image" src="donated/don7.webp" alt="Book Cover">
    <div class="book-details">
        <div class="book-title" id="book-title">Things We Left Behind</div>
        <div class="book-author"><strong>Author:</strong> Lucy Score</div>
        <div class="book-isbn"><strong>ISBN:</strong> 978-1-640631-05-4</div>
        <div class="book-price"><strong>Price:</strong> Rs. 550</div>
        <div class="book-description">
            <strong>Book Description:</strong>
            <p>In "Things We Left Behind," Lucy Score tells a poignant story about love, loss, and the lingering impact of choices made. The novel explores the complexities of relationships and personal growth, resonating deeply with readers seeking emotional connections.</p>
        </div>
