...
<body>
    ...
    <div class="book-container">
        <img class="book-image" src="new/arrival_6.jpg" alt="Book Cover">
        <div class="book-details">
            <div class="book-title" id="book-title">Harry Potter and the Philosopher's Stone</div>
            <div class="book-author"><strong>Author:</strong> J.K. Rowling</div>
            <div class="book-isbn"><strong>ISBN:</strong> 978-0-545582-88-9</div>
            <div class="book-price"><strong>Price:</strong> Rs. 400</div>
            <div class="book-description">
                <strong>Book Description:</strong>
                <p>Harry Potter and the Philosopher's Stone is a fantasy novel written 
                    by the British author J. K. Rowling. It is the first novel in the Harry Potter series and was Rowling's debut novel.</p>
            </div>
