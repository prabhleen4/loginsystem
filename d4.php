...
<div class="book-container">
    <img class="book-image" src="donated/don4.webp" alt="Book Cover">
    <div class="book-details">
        <div class="book-title" id="book-title">Psychopathology of Everyday Life</div>
        <div class="book-author"><strong>Author:</strong> Sigmund Freud</div>
        <div class="book-isbn"><strong>ISBN:</strong> 978-0-393316-26-0</div>
        <div class="book-price"><strong>Price:</strong> Rs. 450</div>
        <div class="book-description">
            <strong>Book Description:</strong>
            <p>In "Psychopathology of Everyday Life," Sigmund Freud explores the significance of slips of the tongue, forgetfulness, and other mundane errors as windows into the unconscious mind. Freud delves into how these everyday occurrences reveal underlying thoughts and emotions, offering profound insights into human behavior and mental processes.</p>
        </div>
