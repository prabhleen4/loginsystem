...
<body>
    ...
    <div class="book-container">
        <img class="book-image" src="new/arrival_9.jpg" alt="Book Cover">
        <div class="book-details">
            <div class="book-title" id="book-title">Ranger's Apprentice: The Ruins of Gorlan</div>
            <div class="book-author"><strong>Author:</strong> John Flanagan</div>
            <div class="book-isbn"><strong>ISBN:</strong> 978-0-142406-63-2</div>
            <div class="book-price"><strong>Price:</strong> Rs. 540</div>
            <div class="book-description">
                <strong>Book Description:</strong>
                <p>The Ruins of Gorlan is the first novel in the Ranger's Apprentice series written by Australian 
                    author John Flanagan. It was first released in Australia on 1 November 2004, and in the United States on 16 June 2005.</p>
            </div>
