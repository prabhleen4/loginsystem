...
<section>
    ...
    <div class="book-container">
        <img class="book-image" src="new/arrival_3.jpg" alt="Book Cover">
        <div class="book-details">
            <div class="book-title" id="book-title">Radical Gardening: Politics, Idealism and Rebellion in the Garden</div>
            <div class="book-author"><strong>Author:</strong> George McKay
            </div>
            <div class="book-isbn"><strong>ISBN:</strong>978-0-711230-30-9</div>
            <div class="book-price"><strong>Price:</strong> Rs.5630</div>
            <div class="book-description">
                <strong>Book Description:</strong>
                <p>The Giver is a 1993 American young adult dystopian novel written by Lois Lowry, 
                    set in a society which at first appears to be utopian but is revealed to be dystopian 
