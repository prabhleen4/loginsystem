...
<section>
    ...
    <div class="book-container">
        <img class="book-image" src="new/arrival_4.jpg" alt="Book Cover">
        <div class="book-details">
            <div class="book-title" id="book-title">Red Queen</div>
            <div class="book-author"><strong>Author:</strong>Victoria Aveyard</div>
            <div class="book-isbn"><strong>ISBN:</strong> 978-6-077357-34-6</div>
            <div class="book-price"><strong>Price:</strong> Rs. 1090</div>
            <div class="book-description">
                <strong>Book Description:</strong>
                <p>Red Queen is a young adult dystopian fantasy romance novel written by American writer Victoria Aveyard. Published 
                    in February 2015, it 
                    was her first novel and first series. Aveyard followed up with three sequels: Glass Sword, King's Cage and War Storm.</p>
            </div>
