...
<body>
    ...
    <div class="book-container">
        <img class="book-image" src="donated/don1.jpg" alt="Book Cover">
        <div class="book-details">
            <div class="book-title" id="book-title">Killing Floor</div>
            <div class="book-author"><strong>Author:</strong> Lee Child</div>
            <div class="book-isbn"><strong>ISBN:</strong> 978-0-451229-11-8</div>
            <div class="book-price"><strong>Price:</strong> Rs. 350</div>
            <div class="book-description">
                <strong>Book Description:</strong>
                <p>In "Killing Floor," Jack Reacher arrives in the small town of Margrave, Georgia, only to be arrested for murder. As he navigates a web of deceit involving counterfeit money and local corruption, Reacher must use his skills to uncover the truth and clear his name.</p>
            </div>
